...
public abstract class HypervisorGuruBase extends AdapterBase implements HypervisorGuru, Configurable {
    ...
    protected VirtualMachineTO toVirtualMachineTO(VirtualMachineProfile vmProfile) {
        ...
        boolean divideMemoryByOverprovisioning = VmMinMemoryEqualsMemoryDividedByMemOverprovisioningFactor.valueIn(clusterId);
        boolean divideCpuByOverprovisioning = VmMinCpuSpeedEqualsCpuSpeedDividedByCpuOverprovisioningFactor.valueIn(clusterId);
