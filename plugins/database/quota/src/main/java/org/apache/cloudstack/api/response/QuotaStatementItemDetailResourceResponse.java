...
public class QuotaStatementItemDetailResourceResponse extends BaseResponse {
    ...
    public QuotaStatementItemDetailResourceResponse(String id, String displayName, boolean removed) {
        super();
        this.id = id;
