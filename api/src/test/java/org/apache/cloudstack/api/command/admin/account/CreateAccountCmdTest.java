...
public class CreateAccountCmdTest {
    ...
    public void testExecuteWithNotBlankPassword() {
        ...
        Mockito.verify(accountService, Mockito.times(1)).createUserAccount(null, "Test", null, null, null, null, null, Account.Type.getFromValue(accountType), roleId, domainId, null, null, null, null);
    }
    ...
    public void testExecuteWithNullPassword() {
        ...
        Mockito.verify(accountService, Mockito.never()).createUserAccount(null, null, null, null, null, null, null, Account.Type.getFromValue(accountType), roleId, domainId, null, null, null, null);
    }
